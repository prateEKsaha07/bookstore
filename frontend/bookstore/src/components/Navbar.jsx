...
// creating a hook to manage a state of creating a shadow under the navigation bar while scrolling 
...
<div className="hidden md:block">
  <label className="input input-bordered px-3 py-2  flex items-center gap-2 dark:bg-slate-900 dark:text-white">
